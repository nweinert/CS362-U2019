...
int testMinion(int choice1, int choice2, int currentPlayer, struct gameState *state, int handPos) {
	...
	int returnVal = minionEffect(choice1, choice2, currentPlayer, state, &state->coins, handPos);
...
int main() {
	...
	for (int i = 0; i < 30; i++) {
		...
		testMinion(choice1, choice2, 0, &G, 0);
