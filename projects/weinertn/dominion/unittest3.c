...
int testAmbassador(int choice1, int choice2, int handPos, int currentPlayer, struct gameState *state, int numPlayers) {
	...
	int returnVal = ambassadorEffect(choice1, choice2, handPos, currentPlayer, state);
...
int main() {
	...
	for (int i = 0; i < 50; i++) {
		...
		testAmbassador(choice1, choice2, 0, 0, &G, 2);
